...
- (void)payMoenyClick {
    ...
    NSString *xmlString = [pay dw_payMoenySetAppid:@"wx53c3f1fd97cfa6a0" Mch_id:@"1369163402" PartnerKey:@"likexiu1504051911782630033123456" Body:@"微信支付测试" Out_trade_no:@"106820009121046" total_fee:[fee intValue] Notify_url:@"www.like.com" Trade_type:@"APP"];
