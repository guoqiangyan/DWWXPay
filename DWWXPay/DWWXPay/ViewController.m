...
- (void)payMoenyClick {
    ...
    NSString *xmlString = [pay dw_payMoenySetAppid:@"appid" Mch_id:@"商户id" PartnerKey:@"商户密钥" Body:@"微信支付测试" Out_trade_no:@"订单号必需为新的订单号，不可以是以存在的订单号" total_fee:[fee intValue] Notify_url:@"回调地址" Trade_type:@"支付类型"];
